...
<?php
    ...
    try {
        ...
        $LoginSql = "SELECT esc_id, esc_nome, esc_email, esc_senha
                     FROM escola 
                     WHERE esc_email = '{$_email}' AND esc_status = '1' ";
        ...
        throw new PDOException($e);
            ...
            if(!empty($resultLogin->esc_id)){
                ...
                <h2 style="font-family:Arial;font-size:25px;color:#333366;margin-bottom:0;margin:0">'.$resultLogin->esc_nome.',</h2>
                ...
                <td><p><b>E-mail de Login:</b> <a href="mailto:'.$resultLogin->esc_email.'" target="_blank">'.$resultLogin->esc_email.'</a></p></td></tr>
                <tr><td><div style="width:100%;margin:0 auto;border-bottom:1px solid #cccccc"></div></td></tr>
                <tr style="font-family:Arial;color:#666666;font-size:15px"><td><p><b><span class="il">Senha</span> de acesso:</b> '.$resultLogin->esc_senha.'</p></td></tr></tbody></table></td></tr>
                ...
                <p style="text-align:center;margin:0;padding:10px 0"><a href="https://www.progresseducacional.com/registro/escola/login.html" target="_blank">WWW.PROGRESSEDUCACIONAL.COM</a></p>
