...
<h2 class="mb-3">Deseja realmente confirmar? </h2>
<!-- <p class="lead"><?php echo $row->aluno_nome?></p> -->
	...
	<div class="card">
		<div class="card-body">
			...
			<a href="<?php echo $url?>!/aluno/confirmar/<?php echo $link[3]?>/<?php echo $link[4]?>/confirmar" class=" btn-lg btn btn-success">Sim • Salvar</a>
		</div>
	</div>
